...
export default function FormNote({title, content, setVisible, handleSubmit, visible, setNote, note, folderHidden}) {
    ...
    return (
        <form className="w-full flex flex-col justify-start items-start relative" onSubmit={handleSubmit}>
            ...
            <textarea placeholder="Write the content of the note" spellCheck="false" onChange={handleChange} name="content" value={content && content}  className="w-full h-full resize-none p-3 pl-5 text-lg bg-transparent focus:outline-none placeholder-slate-500 dark:placeholder-gray-500"></textarea>

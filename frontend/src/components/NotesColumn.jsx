...
export default function NotesColumn({children, title, buttonDelete, folderId}) {
  ...
  return (
    <div className="max-w-[200px] md:min-w-[300px] bg-orange-100 dark:bg-zinc-800 overflow-y-auto h-screen relative">
      <div>
